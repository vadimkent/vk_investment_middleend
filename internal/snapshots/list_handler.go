...
// Get serves GET /actions/snapshots/list: validates query params, calls the
// use case for the list subtree, and returns an ActionResponse that replaces
// the snapshots-section node. Snapshot or catalog ErrUnauthorized → 401 with
// redirect; any other backend error → 502 BACKEND_ERROR.
